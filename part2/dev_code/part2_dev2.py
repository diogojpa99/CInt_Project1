...
temp = ctrl.Antecedent(np.arange(19.9, 21.38+1, 0.001), 'Temp') 
...
temp['cold'] = fuzz.trimf(temp.universe,[19.9, 19.9 ,20.5])
temp['hot'] = fuzz.trimf(temp.universe,[20.3, 21 , 21.38])
