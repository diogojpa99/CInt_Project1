...
def multiclass_model_1(X_train, Y_train, X_test, Y_test, sm):
    ...
    mlp = MLPClassifier(hidden_layer_sizes=(12,), activation='logistic',
                        solver = 'sgd', alpha = 0.003, learning_rate='constant', 
                        max_iter = 600, learning_rate_init = 0.02).fit(X_train,Y_train)
...
# According to model()
def multiclass_model_2(X_train, Y_train, X_test, Y_test, sm):
...
def multiclass_model_3(X_train, Y_train, X_test, Y_test, sm):
    ...
    mlp = MLPClassifier(hidden_layer_sizes=(10,), activation='tanh',
                        solver = 'adam', alpha = 0.0005, learning_rate='constant', 
...
print("--------- multiclass_model_1 ----------")
multiclass_model_1(x_train, y_train, x_test, y_test, sm = True)
print("--------- best_multiclass_model_2 ----------")
multiclass_model_2(x_train, y_train, x_test, y_test, sm = True) #Best Model
print("--------- best_multiclass_model_3 ----------")
multiclass_model_3(x_train, y_train, x_test, y_test, sm = True)